...
<head>
  ...
  <style>
    body, table, td, th, a, h1, h2, h3, p { font-family: 'Open Sans', Arial, sans-serif; }
    @media screen and (max-width: 600px) {
      .mobile-stack { display: block !important; width: 100% !important; margin-bottom: 20px !important; box-sizing: border-box; text-align: center !important; }
      .mobile-hide { display: none !important; }
      .center-text { text-align: center !important; }
      .hero-img { width: 100% !important; height: auto !important; }
      .button-stack td { display: block !important; width: 100% !important; padding: 5px 0 !important; }
    }
  </style>
</head>

<body style="margin: 0; padding: 0; background-color: #F0E6FA;">
  <!-- Preheader Spacer Hack -->
  <div style="display:none;font-size:1px;color:#F0E6FA;line-height:1px;max-height:0px;max-width:0px;opacity:0;overflow:hidden;mso-hide:all;">
    B\u1ea1n \u0111\u00e3 gieo h\u1ea1t v\u00e0 ch\u0103m s\u00f3c c\u00e1i c\u00e2y c\u1ee7a m\u00ecnh qua giai \u0111o\u1ea1n t\u00edch l\u0169y. \u0110\u1eebng nh\u1ed5 n\u00f3 l\u00ean tr\u01b0\u1edbc khi t\u00e1n l\u00e1 \u0111\u1ee7 r\u1ed9ng \u0111\u1ec3 che b\u00f3ng m\u00e1t.
    &zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;&zwnj;&nbsp;
  </div>

  <table width="100%" bgcolor="#F0E6FA" cellpadding="0" cellspacing="0" border="0">
    <tr>
      <td align="center" style="padding: 10px 0 0 0;">
        <table width="600" cellpadding="0" cellspacing="0" border="0" style="max-width: 600px; width: 100%;">
          ...
          <!-- Logo -->
          <tr>
            <td style="padding: 10px 20px 10px 20px;" align="center" class="center-text">
              <a href="https://link.kfsp.vn/webhook/email-click?u={{ $json.user_id }}&amp;e={{ $json.email }}&amp;c=10_ngay_sau_sinh_nhat&amp;src=email_10_ngay_sau_sinh_nhat_paid_expiring_logo&amp;r=https%3A%2F%2Fkfsp.vn"><img
                src="https://cdn.jsdelivr.net/gh/kfspteam/email-assets@main/logo/logo.png" width="40" alt="KFSP Logo"
                style="display: inline-block; max-width: 40px; border: 0;" /></a>
            </td>
          </tr>

          <!-- [T\u1ea7ng 3] Offset Title Banner -->
          <tr>
            <td style="padding: 0 20px 40px 20px;" align="center">
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td bgcolor="#111827" style="border-radius: 12px; padding: 0 8px 8px 0;">
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#7B3AEC"
                      style="border-radius: 12px; border: 2px solid #111827;">
                      <tr>
                        <td style="padding: 30px 20px; text-align: center;">
                          <h1 style="color: #FFFFFF; font-size: 16px; font-weight: 900; line-height: 1.4; margin: 0; letter-spacing: 1px; text-transform: uppercase;">
                            B\u1ea0N \u0110\u00c3 GIEO H\u1ea0T V\u00c0 CH\u0102M S\u00d3C C\u00c1I C\u00c2Y N\u00c0Y<br>
                            <span style="color: #FDE68A;">\u0110\u1eebNG NH\u1ed4 N\u00d3 L\u00caN TR\u01af\u1edcC KHI T\u00c1N L\u00c1 \u0110\u1ee6 R\u1ed8NG \u0110\u1ec2 CHE B\u00d3NG M\u00c1T</span>
                          </h1>
                        </td>
                      </tr>
                    </table>
          ...
          <tr>
            <td style="padding: 10px 20px 30px 20px;">
              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <!-- [T\u1ea7ng 4] QUOTE + LU\u1eacN \u0110I\u1ec2M -->
                <tr>
                  <td align="left" valign="top" style="font-weight: normal; padding-bottom: 20px;">
                    <div style="font-weight: bold; font-size: 12px; color: #7B3AEC; margin-bottom: 10px; letter-spacing: 2px;">B\u1ea2O V\u1ec6 TH\u00c0NH QU\u1ea2</div>
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#F5F3FF" style="border-radius: 10px; border-left: 4px solid #7B3AEC; margin-bottom: 16px;">
                      <tr>
                        <td style="padding: 14px 16px;">
                          <p style="margin: 0 0 6px 0; font-size: 14px; color: #111827; line-height: 1.6; font-style: italic;">&ldquo;Someone is sitting in the shade today because someone planted a tree a long time ago.&rdquo;</p>
                          <p style="margin: 0; font-size: 12px; color: #7B3AEC; font-weight: 700;">&mdash; WARREN BUFFETT &nbsp;|&nbsp; H\u00f4m nay c\u00f3 ng\u01b0\u1eddi \u0111ang ng\u1ed3i trong b\u00f3ng m\u00e1t, v\u00ec t\u1eeb l\u00e2u tr\u01b0\u1edbc \u0111\u00f3 \u0111\u00e3 c\u00f3 ng\u01b0\u1eddi tr\u1ed3ng c\u00e2y.</p>
                        </td>
                      </tr>
                    </table>
                    <p style="margin: 0 0 12px 0; font-size: 14px; color: #111827; line-height: 1.7;">B\u1ea1n kh\u00f4ng th\u1ec3 thu ho\u1ea1ch l\u1ee3i nhu\u1eadn l\u1edbn n\u1ebfu ch\u1ec9 nh\u00ecn th\u1ecb tr\u01b0\u1eddng theo t\u1eebng ng\u00e0y hay t\u1eebng tu\u1ea7n r\u1eddi r\u1ea1c. Th\u1eddi gian qua, chi ph\u00ed v\u00e0 c\u00f4ng s\u1ee9c b\u1ea1n b\u1ecf ra cho g\u00f3i d\u1ecbch v\u1ee5 kh\u00f4ng ch\u1ec9 \u0111\u1ec3 t\u00ecm v\u00e0i m\u00e3 l\u01b0\u1edbt s\u00f3ng ng\u1eafn h\u1ea1n, m\u00e0 l\u00e0 \u0111\u1ec3 nu\u00f4i d\u01b0\u1ee1ng m\u1ed9t qu\u00e1n t\u00ednh quan s\u00e1t c\u00f3 k\u1ef7 lu\u1eadn, x\u00e2y d\u1ef1ng danh m\u1ee5c theo d\u00f5i v\u00e0 t\u00edch l\u0169y d\u1eef li\u1ec7u v\u1ec1 nh\u1eefng c\u1ed5 phi\u1ebfu ti\u1ec1m n\u0103ng.</p>
                    <p style="margin: 0 0 12px 0; font-size: 14px; color: #111827; line-height: 1.7;">V\u1ea5n \u0111\u1ec1 xu\u1ea5t hi\u1ec7n ngay l\u00fac n\u00e0y, khi g\u00f3i t\u00e0i kho\u1ea3n chu\u1ea9n b\u1ecb h\u1ebft h\u1ea1n, s\u1ef1 \u0111\u1ee9t qu\u00e3ng theo d\u00f5i ch\u00ednh l\u00e0 r\u1ee7i ro l\u1edbn nh\u1ea5t. Nh\u1eefng m\u1eabu h\u00ecnh b\u1ea1n theo d\u00f5i r\u00f2ng r\u00e3 c\u1ea3 th\u00e1ng qua v\u1eabn \u0111ang v\u1eadn \u0111\u1ed9ng; nh\u01b0ng ch\u1ec9 c\u1ea7n ng\u1eaft k\u1ebft n\u1ed1i v\u00e0i phi\u00ean, b\u1ea1n s\u1ebd m\u1ea5t to\u00e0n b\u1ed9 ng\u1eef c\u1ea3nh, l\u1ee1 m\u1ea5t t\u00edn hi\u1ec7u c\u1ea3nh b\u00e1o t\u1ea1i \u0111i\u1ec3m b\u1ee9t ph\u00e1 v\u00e0 \u0111\u1ec3 c\u00f4ng s\u1ee9c quan s\u00e1t b\u1ea5y l\u00e2u tr\u1edf n\u00ean v\u00f4 ngh\u0129a.</p>
                    <p style="margin: 0; font-size: 14px; color: #111827; line-height: 1.7;">B\u1ea1n \u0111\u00e3 gieo h\u1ea1t v\u00e0 ch\u0103m ch\u00fat c\u00e1i c\u00e2y c\u1ee7a m\u00ecnh qua giai \u0111o\u1ea1n t\u00edch l\u0169y. \u0110\u1eebng nh\u1ed5 n\u00f3 l\u00ean ngay tr\u01b0\u1edbc khi t\u00e1n l\u00e1 \u0111\u1ee7 r\u1ed9ng \u0111\u1ec3 che b\u00f3ng m\u00e1t, h\u00e3y \u0111\u1ec3 n\u00f3 l\u1edbn l\u00ean v\u00e0 k\u1ebft tr\u00e1i ng\u1ecdt cho b\u1ea1n qua t\u1eebng m\u00f9a s\u00f3ng c\u1ee7a th\u1ecb tr\u01b0\u1eddng.</p>
                  </td>
                </tr>

                <!-- [T\u1ea7ng 5] BRIDGE + \u1ea2NH TH\u1ef0C T\u1ebe -->
                <tr>
                  <td align="left" valign="top" style="font-weight: normal; padding-bottom: 16px;">
                    <p style="margin: 0 0 14px 0; font-size: 14px; color: #111827; line-height: 1.7;">Giai \u0111o\u1ea1n th\u1ecb tr\u01b0\u1eddng ph\u00e2n h\u00f3a v\u1eeba qua, nh\u1eefng m\u00e3 \u0111ang t\u00edch l\u0169y v\u00e0 chu\u1ea9n b\u1ecb b\u1ee9t ph\u00e1 kh\u00f4ng t\u1ef1 b\u00e1o hi\u1ec7u. Ch\u00fang c\u1ea7n \u0111\u01b0\u1ee3c theo d\u00f5i li\u00ean t\u1ee5c t\u1eeb giai \u0111o\u1ea1n t\u00edch l\u0169y cho t\u1edbi khi x\u00e1c nh\u1eadn.</p>
                  </td>
                </tr>
                <tr>
                    ...
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width: 480px; margin: 0 auto;">
                      <tr>
                        <td align="center" valign="middle" style="padding: 0;">
                          <img src="https://link.kfsp.vn/email-assets/mockup/co_hoi_tiem_nang/CH_09_Tab_TichLuy.jpg"
                            style="display: block; width: 100%; max-width: 100%; height: auto; border-radius: 12px; border: 1px solid #E5E7EB;"
                            alt="T\u1ea7m so\u00e1t c\u00e1c c\u1ed5 phi\u1ebfu \u0111ang t\u1ea1o n\u1ec1n T\u00edch L\u0169y \u0111\u1ec3 s\u1eb5n s\u00e0ng gi\u1ea3i ng\u00e2n" />
                          <p style="font-size: 12px; color: #6B7280; text-align: center; font-style: italic; margin-top: 8px; margin-bottom: 0;">H\u1ec7 th\u1ed1ng theo d\u00f5i li\u00ean t\u1ee5c v\u00e0 c\u1eadp nh\u1eadt tr\u1ea1ng th\u00e1i m\u1ed7i ng\u00e0y. Kho\u1ea3ng tr\u1ed1ng trong quan s\u00e1t l\u00e0 kho\u1ea3ng tr\u1ed1ng trong l\u1ee3i nhu\u1eadn.</p>
                        </td>
                      </tr>
                    </table>
                  </td>
                ...
                <tr>
                  <td align="left" valign="top" style="font-weight: normal; padding-bottom: 20px;">
                    <p style="margin: 0; font-size: 14px; color: #111827; line-height: 1.7;">\u0110\u00e2y l\u00e0 giai \u0111o\u1ea1n b\u1ea1n \u0111\u00e3 \u0111\u1ea7u t\u01b0 th\u1eddi gian \u0111\u1ec3 quen v\u1edbi h\u1ec7 th\u1ed1ng. \u0110\u1eebng \u0111\u1ec3 s\u1ef1 quen thu\u1ed9c \u0111\u00f3 b\u1ecb m\u1ea5t \u0111i.</p>
                  </td>
                </tr>
                ...
                <div style="width: 100%; max-width: 480px; margin: 0 auto; position: relative; z-index: 1; font-family: 'Open Sans', Arial, sans-serif;">
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0" border="0"
                    ...
                    <tr><td style="padding: 22px 20px; font-family: 'Open Sans', Arial, sans-serif;">
                      <div style="display: inline-block; background-color: #FEF08A; color: #854D0E; font-size: 11px; font-weight: 800; padding: 6px 14px; border-radius: 20px; text-transform: uppercase; margin-bottom: 12px; letter-spacing: 0.5px; font-family: 'Open Sans', Arial, sans-serif;">
                        [QUEN] Qu\u00e0 sinh nh\u1eadt v\u1eabn \u0111ang ch\u1edd
                      </div>
                  ...
                  <div style="background-color: #FFFBEB; border-radius: 20px; padding: 12px 10px; margin-bottom: 10px; text-align: center; border: 1px solid #FEF08A; box-shadow: 0 10px 25px rgba(217,119,6,0.1); font-family: 'Open Sans', Arial, sans-serif;">
                    ...
                    <a href="https://link.kfsp.vn/webhook/email-register?plan=gold_2y&amp;email={{ $json.email }}&amp;u={{ $json.user_id }}&amp;source=email_10_ngay_sau_sinh_nhat_paid_expiring&amp;c=10_ngay_sau_sinh_nhat&amp;content=cta_gold_2y"
                      target="_blank"
                  ...
                  <div style="background-color: #F5F3FF; border-radius: 20px; padding: 12px 10px; margin-bottom: 10px; text-align: center; border: 1px solid #E9D5FF; box-shadow: 0 10px 25px rgba(126,34,206,0.1); font-family: 'Open Sans', Arial, sans-serif;">
                    ...
                    <a href="https://link.kfsp.vn/webhook/email-register?plan=gold_1y&amp;email={{ $json.email }}&amp;u={{ $json.user_id }}&amp;source=email_10_ngay_sau_sinh_nhat_paid_expiring&amp;c=10_ngay_sau_sinh_nhat&amp;content=cta_gold_1y"
                      target="_blank"
                  ...
                  <div style="background-color: #F0FDF4; border-radius: 20px; padding: 12px 10px; margin-bottom: 10px; text-align: center; border: 1px solid #D1FAE5; box-shadow: 0 10px 25px rgba(5,150,105,0.05); font-family: 'Open Sans', Arial, sans-serif;">
                    ...
                    <a href="https://link.kfsp.vn/webhook/email-register?plan=silver_3m&amp;email={{ $json.email }}&amp;u={{ $json.user_id }}&amp;source=email_10_ngay_sau_sinh_nhat_paid_expiring&amp;c=10_ngay_sau_sinh_nhat&amp;content=cta_silver_3m"
                      target="_blank"
...
with open("KFSP_Email_PaidExpiring_Final_V5.html", "w", encoding="utf-8") as f:
    f.write(html)

print("PaidExpiring rebuilt OK")
