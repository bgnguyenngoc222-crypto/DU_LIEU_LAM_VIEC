  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Content */}
        <div style={{ flex: 1 }}>
          <div style={{ color: C.red, fontSize: 22, fontWeight: 800, letterSpacing: 1.5, textTransform: 'uppercase', marginBottom: 4 }}>
            {author}
          </div>
          <div style={{ color: C.white, fontSize: 32, fontWeight: 700, lineHeight: 1.35 }}>
            "{quote}"
          </div>
        </div>
